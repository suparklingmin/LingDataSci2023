...
|회차|날짜|제목|슬라이드|실습|자료|
|--|--|--|--|--|--|
|1강|2023-09-04(월)|강의 소개: 오리엔테이션, 데이터의 정의, 언어데이터의 범위|||
|2강|2023-09-06(수)|환경 설정: git, Google Colab|||
||2023-09-06(수)|[숙제00] 수강생 배경 조사||||
||2023-09-08(금)|[숙제01] git 설치 인증||||
|3강|2023-09-11(월)|Linux 기초|||
|4강|2023-09-13(수)|AWK와 정규표현식을 활용한 텍스트 처리|||
||2023-09-15(금)|[숙제02] AWK 연습||||
|5강|2023-09-18(월)|데이터과학 (1): 데이터의 네 가지 유형, 탐색적 자료 분석(EDA)|||
|6강|2023-09-20(수)|데이터과학 (2): 기술통계량의 한계|||
